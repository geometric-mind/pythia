/-
Pythia.Tactic.Z3Check — Phase 1 of the cross-prover hammer
: the `z3_check` tactic.
...
Phase 1. Phase 2 expands to nonlinear (Z3 + nlinarith),
...
def runZ3 (smt : String) : IO Verdict := do
  ...
  let tmpFile := s!"{tmpDir}/pythia_z3_check_{stamp}.smt2"
