...
**Coverage**:
- 1365 theorem/lemma declarations in `Pythia/`
- 216 `@[stat_lemma]`-tagged theorems in the `pythia` tactic cascade
...
The repository includes a full-text search index over all 887
