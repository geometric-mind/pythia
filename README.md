...
mathematics and computer science. It provides 1274 sorry-free theorems
...
**Coverage**:
- 1814 theorem/lemma declarations in `Pythia/`
...
| `Pythia.Hardware` | 377 | k-induction soundness, bit-vector modular arithmetic, Gray code single-bit adjacency, FIFO pointer conditions, Hamming distance metric and detection/correction capacity, Singleton bound, CDC synchronizer MTBF exponential growth |
...
| `Pythia.Numerical` | 238 | KKT necessary/sufficient conditions (Slater, Lagrangian sandwich), Picard-Lindelof, Lyapunov stability, Kahan compensated summation, Forward Euler truncation, IEEE-754 round-to-nearest, QR factorization, Weyl/Bauer-Fike eigenvalue bounds, gradient descent convergence, MatMul/Softmax/LayerNorm/Attention numerical error bounds (Higham Thm 3.1), NKI accelerator reduction-tree error, tiled matmul composition, FP16→FP32 quantized reduction |
...
The repository includes a full-text search index over all 1274
