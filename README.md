...
**Coverage**:
- 1446 theorem/lemma declarations in `Pythia/`
- 292 `@[stat_lemma]`-tagged theorems in the `pythia` tactic cascade
...
The repository includes a full-text search index over all 
