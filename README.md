...
systems, and quantitative finance. All proofs close under the standard
...
**Coverage**:
- 1381 theorem/lemma declarations in `Pythia/`
- 232 `@[stat_lemma]`-tagged theorems in the `pythia` tactic cascade
...
The repository includes a full-text search index over all 903
