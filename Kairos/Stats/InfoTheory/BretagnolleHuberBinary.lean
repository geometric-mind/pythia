/-
Kairos.Stats.InfoTheory.BretagnolleHuberBinary

Binary-alphabet Bretagnolle-Huber inequality, the fallback for ATH-634.
...
namespace Kairos.Stats.InfoTheory
...
end Kairos.Stats.InfoTheory

/-! ## Axiom audit

Run `#print axioms Kairos.Stats.InfoTheory.bretagnolle_huber_binary` to verify
