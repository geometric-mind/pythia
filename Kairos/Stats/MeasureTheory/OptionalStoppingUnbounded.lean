/-
Kairos.Stats.MeasureTheory.OptionalStoppingUnbounded — optional stopping
...
`wald_identity_squared` in `Kairos/Stats/WaldIdentity.lean`), and the
SPRT closure (`Kairos/Stats/SPRT.lean`).
...
## Closure status (2026-04-25, ATH-605 / kairos-stats-lean)
...
namespace Kairos.Stats.MTUnbounded
