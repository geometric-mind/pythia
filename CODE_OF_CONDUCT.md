...
the pythia community a harassment-free experience for everyone,
...
* Focusing on what is best for the overall community, not just for
  ourselves
* Crediting prior work and prior contributors. Mathematical
  proofs build on a long history; cite generously.

Examples of unacceptable behavior:

* Harassment, including the use of sexualized language or imagery, and
...
* Publishing others' private information without their explicit
  permission
* Attempting to discredit a contribution by attacking the contributor
  rather than engaging with the proof or argument
...
project repository, Linear tickets, issue tracker, pull request reviews,
and any official communication channel. It also applies when an
...
[athanor.ai](https://athanor.ai) (subject line: "pythia code of
conduct"). All complaints will be reviewed and investigated promptly and
fairly.
...
conduct enforcement ladder][mozilla].
